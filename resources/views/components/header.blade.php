        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('dashboard') }}" class="flex ml-2 md:mr-24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Kopi Oetama</span>
                </a>

            </div>
            <div class="flex items-center">
                <button type="button" data-tooltip-target="notif-toggle" data-dropdown-toggle="notification-dropdown" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                ...
                <div id="notif-toggle" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
                    Notifications<div class="tooltip-arrow" data-popper-arrow></div>
                </div>
                    ...
                    @forelse ($notifications as $notification)
                        <div class="flex px-4 py-3 border-b hover:bg-gray-100">
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="profile image" />
                                <div class="absolute flex items-center justify-center w-5 h-5 ml-6 -mt-5 border border-white rounded-full bg-primary-700">
                                    <!-- Notification Icon -->
                                    <!-- You can customize the icon for each type of notification -->
                                </div>
                            </div>
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                ...
                                <form action="{{ route('logout') }}" method="POST" role="menuitem">
                                    @csrf
                                    <button type="submit" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white w-full text-start">
                                        Sign out
                                    </button>
                                </form>
                            </li>
